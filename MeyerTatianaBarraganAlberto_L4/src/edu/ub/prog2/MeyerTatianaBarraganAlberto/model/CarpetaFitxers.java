...
public class CarpetaFitxers implements Serializable, InFileFolder{
    ...
    public void addFitxer(File fitxer) throws AplicacioException {
        if(!isFull()){
           ...
           throw new AplicacioException("El álbum está lleno.");
        }
    }
    ...
    public File getFitxer(File fitxer) {
        ...
        System.out.println("No se ha encontrado el fichero a borrar.");
        return null;
    }
    ...
    public String toString() {
        ...
        while(fileIt.hasNext()) {
            ...
            sb.append(cont).append(". ").append(currentFile.getDescripcio()).append(" [")
